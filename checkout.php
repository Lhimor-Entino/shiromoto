   ...
   <section class="checkout-orders">
      <form action="" method="POST">
         ...
         <div class="flex">
            ...
            <div class="inputBox">
               <span>Number :</span>
               <input type="text" name="number" id="number" placeholder="enter your number" class="box" min="0" max="9999999999" onkeypress="if(this.value.length == 10) return false;" required>
            </div>
            <div class="inputBox">
               <span>Email :</span>
            ...
            <div class="inputBox">
               <span>Address:</span>
               <input type="text" name="address" id="address" placeholder="" class="box" maxlength="50" required>
            </div>
            <div class="inputBox">
               <span>Barangay/Street:</span>
               <input type="text" name="brgy" id="brgy" placeholder="" class="box" maxlength="50" required>
            </div>
            <div class="inputBox">
               <span>City :</span>
               <input type="text" name="city" id="city" placeholder="" class="box" maxlength="50" required>
            </div>
            <div class="inputBox">
               <span>Postal Code :</span>
               <input type="number" min="0" name="pin_code" id="pin_code" placeholder="" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box" required>
            </div>
         </div>
